...
# ['(0-2)', '(4-6)', '(8-12)', '(15-20)',
#            '(25-32)', '(38-43)', '(48-54)', '(60-100)']


@sio.event
def my_message(data):
    te = ''
    if data == '(0-2)' or data == '(4-6)' or data == '(8-12)':
        te = 'children'
    else:
        te = 'adult'
    sio.emit('say', te)
...
def highlightFace(net, frame, conf_threshold=0.8):
    ...
    img = ((frameOpencvDnn / np.max(frameOpencvDnn)) * 255).astype('uint8')
...
while cv2.waitKey(1) < 0:
    ...
    for faceBox in faceBoxes:
        ...
        cv2.putText(resultImg, f'{age}', (faceBox[0], faceBox[1]-10),
